...
export const renderTwitchSubBadge = (tier: number): ReactNode => {
  ...
  return (
    <span className="twitch-chat-badge" title={`Subscriber Tier ${tier}`} style={{ marginRight: '4px', verticalAlign: 'middle' }}>
...
export const renderDonationBadge = (): ReactNode => {
  return (
    <span className="twitch-chat-badge" title="Donation" style={{ marginRight: '4px', verticalAlign: 'middle' }}>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ borderRadius: '2px' }}>
...
export const renderBroadcasterBadge = (): ReactNode => {
  return (
    <span className="twitch-chat-badge" title="Broadcaster" style={{ marginRight: '4px', verticalAlign: 'middle' }}>
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ borderRadius: '2px' }}>
